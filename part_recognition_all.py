...
pool_integrate = p.Population(integrate_size * integrate_size, p.SpikeSourceArray, {'spike_times': spikeTrains[5] }, label='pool_integrate')
...
filename = 'results/16/integrate.spikes'
pool_integrate.printSpikes(filename)
for iTemplate in range (0, num_templates):
    filename = 'results/16/recog_%d.spikes' %(iTemplate)
