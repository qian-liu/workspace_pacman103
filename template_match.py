...
input_pop = p.Population(input_size * input_size,         # size
                       ...
                       label="Input") # Label
''' Move the spikesource array down to the end
retina_pop = []
...
for iTemplate in range (0, num_templates):
    ...
    exci_list, inhi_list, recognition_size = convConnector2(pooling_out_size, template_weight, 1, 1) #generate the weights for the template convolution
