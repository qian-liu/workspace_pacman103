...
xlabel('Time in ms')
ylabel('Spikes rates');
set(gca,'Xlim',[0,run_time/frame_len],'XTick',[0:run_time/frame_len/10:run_time/frame_len] ,'XTicklabel',0:run_time/10:run_time);
...
xlabel('Time in ms')
ylabel('Spikes rates');
set(gca,'Xlim',[0,run_time/frame_len],'XTick',[0:run_time/frame_len/10:run_time/frame_len] ,'XTicklabel',0:frame_len/10:frame_len);
