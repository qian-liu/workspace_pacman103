...
pool_integrate = p.Population(integrate_size * integrate_size,
...
for i in range(source_Num):
    ...
    p.Projection(integrate_pop[i], pool_integrate, p.OneToOneConnector(weights=input_weights, delays=1), label='input projection')
